...
l_df = [speech_df, sum_df]
for i in range(len(l_df)):
    l_df[i] = filter_speech_fun(l_df[i], "parliament",
                         parliaments[select_parliament])

speech_df, sum_df = l_df
...
with by_member:
    ...
    if select_parliament!="All":
        ...
        if 'All' not in selected_constituency:
            ...
            for i in range(len(l_df)):
                l_df[i] = filter_speech_fun(l_df[i], "member_constituency",
    ...
    if 'All' not in selected_members:
        ...
        for i in range(len(l_df)):
            l_df[i] = filter_speech_fun(l_df[i], "member_name",
                                 selected_members)
